#ifndef LOUIERIKSSON_REQUESTS_HPP
#define LOUIERIKSSON_REQUESTS_HPP
...
/*
 * Note:
 *      On linux, open terminal and type "nc -l 8080" to listen to port 8080 with netcat.
...
namespace LouiEriksson::Networking {
...
#endif //LOUIERIKSSON_REQUESTS_HPP